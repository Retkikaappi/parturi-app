...
function App() {
  return (
    <div className='m-auto w-ma text-center min-h-dvh h-dvh text-white bg-[url(https://cdn.vectorstock.com/i/1000v/39/94/seamless-pattern-background-barber-shop-vector-4683994.jpg)]'>
      <div className='bg-slate-800 w-5/6 h-dvh m-auto'>
